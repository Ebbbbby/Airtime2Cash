...
const PlatForm = () => {
  return (
 <section>
  <div className="platform__wrapper container ">
    <div className="platform__container">
    <div className="platform">
       <h3>  
       The best platform for your convenient airtime exchange
       </h3>
       <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Malesuada quam malesuada in ultrices augue ac maecenas.</p>
        <a href="#getStarted" className='btn  getStarted__btn'>Get Started</a>
    </div>
